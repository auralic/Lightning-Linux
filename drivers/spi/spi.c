		...
		if (!(spi->mode & SPI_NO_CS)) {
			if (spi->cs_gpiod) {
				...
				if (has_acpi_companion(&spi->dev))
                {
                    if(!enable)
                    {
                        printk(KERN_ERR "set spi cs to 1..\n");
                    }
                    else
                    {
                        printk(KERN_ERR "set spi cs to 0..\n");
                    }
					...
					/* Polarity handled by GPIO library */
                {
                    if(activate)
                    {
                        printk(KERN_ERR "1set spi cs to 1..\n");
                    }
                    else
                    {
                        printk(KERN_ERR "1set spi cs to 0..\n");
                    }
